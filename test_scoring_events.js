...
for(const [type,lethal] of [['KNIFE',true],['BAT',false]]){
 ...
 const c={Collision:require('./js/engine/collision'),mapData:{walls:[]},enemies:[enemy],thrownWeapons:[weapon],floorWeapons:[],particleSystem:null,camera:null,runStats:{totalKills:0,weaponsUsed:new Set()},awardKill:(...a)=>awards.push(a),hud:{addScore:(...a)=>awards.push(a)},collectEnemyDrop:()=>{}};
