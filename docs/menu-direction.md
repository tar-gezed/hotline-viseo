...
`npm test` exécute 30 suites, dont `test_menu_navigation.js` : navigation avec le vrai `InputManager`, fronts manette, retour personnage, volumes indépendants, stockage invalide/bloqué et coordonnées dans les quatre formats.
