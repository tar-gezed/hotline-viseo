...
Mise à jour d’intégration du 18 septembre 2026 : l’écran **CONTRÔLES** documente Espace et △/Y pour l’action exécution/porte. La refonte des menus ne modifie pas les règles physiques décrites dans cette revue ; leurs régressions font partie des 31 suites actuelles. Voir [direction des menus](menu-direction.md).
...
Les rejets géométriques rapides ne modifient pas la résolution des contacts proches ni les réactions des battants. Les angles, verrous et vitres brisées restent lus immédiatement. Les tests de portes et de navigation passent, complétés par une comparaison de 15 000 requêtes géométriques avec `84afbfb`. Voir la [méthode et ses limites](game-performance.md).
