...
`npm test` exécute les 31 suites actuelles. `test_scoring.js` vérifie aussi l’indépendance des impacts visuels, leur extinction, le reset, l’absence de réannonce lors des synchronisations répétées et le decay inchangé.
